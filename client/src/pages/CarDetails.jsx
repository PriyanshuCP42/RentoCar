...
import { assets, dummyCarData } from '../assets/asset'
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
          ...
          <div className='lg:col-span-2'>
            ...
            <div className='space-y-6'>
              ...
              <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
                  {[
                    ...
                    <div key={text} className='flex flex-col items-center bg-light p-4 rounded-lg'>
                        <img src={icon} alt="" className='h-5 b-2'/>
                        {text}
                    </div>
                  ))}
              </div>
              {/* Description */}
              <div>
                <h1 className='text-xl font-medium b-3'>Description</h1>
                <p className='text-gray-500'>{car.description}</p>
              </div>

              {/* festures */}
                  <div>
                    <h1 className='text-xl font-medium mv-3'>Features</h1>
          ...
          <form className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
                  <p className='flex items-center jsutify-between text-2xl text-gray-800 font-semibold'>
                    {currency}{car.pricePerDay}
                    <span className='text-base text-gray-400 font-normal ml-55'>per day</span>
                  </p>
                  ...
                  <button onSubmit={handleSubmit} className='w-full bg-primary hover:bg-primary-dull transition-all py-3 font-medium
